...
## Course Description For HIS8G Grade 8 History Online Course

In Grade 8 history, students will build on their understanding of earlier Canadian history, examining how social, political, economic, and legal changes in Canada between 1850 and 1914 affected different individuals, groups, and communities, including First Nations, Métis, and Inuit individuals and communities, in an increasingly diverse and regionally distinct nation.

## HIS8G Online Course Outline and Timeline

Below is the suggested sequence of course unit delivery as well as the recommended number of hours to complete the respective unit. For complete details of targeted expectations within each unit and activity, please see each Unit Overview found in the HIS8G course profile.

| Unit Order | Unit Name | Suggested Time |
| --- | --- | --- |
| Unit 1 | Confederation | 20 Hours |
| Unit 2 | Settling Western Canada | 20 Hours |
| Unit 3 | Changing Society | 20 Hours |
| FINAL | Final Exam | 2 Hours |
| [View Sample Gradebook](/OVS/login/get_gradebook.php?course=his8g) Total | | 62 Hours |
...
## HIS8G Frequently Asked Questions

### How Long Does it take to Complete the HIS8G Online Course?
...
2. **Embed Video**: Grade 8 History HIS8G Sample lesson
   - URL: `about:blank;`
3. **Vimeo Video**: HIS8G Grade 8 History
   - URL: `https://player.vimeo.com/video/1?title=0&byline=0&portrait=0&color=ffffff&autoplay=1&dnt=0&muted=0`
