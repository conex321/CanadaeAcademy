# CGC1DF |Grade 9 French Immersion Issues in Canadian Geography| OVS

**Source:** https://www.ontariovirtualschool.ca/courses/cgc1wf
**Description:** CGC1DF Grade 9 French Immersion Issues in Canadian Geography. Academic online course for students. Learn at home & earn OSSD credits with OVS. Sign up to start at any time.

---

![CGC1WF](data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs%3D)
**Course Code: CGC1WF**
**Course Type:
Open**
**Format:
...
French**
**Prerequisite:
grade 8 early or late Immersion**
**Tuition Fee (CAD):
$449**
Add to Cart
[Demo Lesson](#iframe_container)
## Course Description For CGC1WF Enjeux géographiques du Canada, 9e année, décloisonné. Online Course

Ce cours permet à l’élève d’examiner les liens existants entre les environnements naturel et humain au Canada, de mieux comprendre certaines interactions au sein de ces environnements ainsi que leurs liens avec d’autres environnements dans le monde. L’élève explore des thèmes comme la distribution spatiale et le développement des ressources naturelles, les choix énergétiques et la croissance urbaine. En utilisant les concepts de la pensée critique et le processus d’enquête en géographie, incluant les technologies spatiales, l’élève acquiert les compétences qui lui sont nécessaires pour analyser des enjeux géographiques et déterminer des solutions durables pour le Canada. Préalable : Aucun

## CGC1WF Online Course Outline and Timeline

Below is the suggested sequence of course unit delivery as well as the recommended number of hours to complete the respective unit. For complete details of targeted expectations within each unit and activity, please see each Unit Overview found in the CGC1WF course profile.
...
| Unit 6 | Course Summative (Independent Study) | 12 Hours |
| FINAL | Final Exam | 3 Hours |
| [View Sample Gradebook](/OVS/login/get_gradebook.php?course=cgc1wf) Total | | 110 Hours |
...
Reference: [Canadian and World Studies, The Ontario Curriculum, Grades 9 and 10, 2018 (Revised) Ministry of Education of Ontario](http://www.edu.gov.on.ca/eng/curriculum/secondary/canworld910curr2018.pdf)

[Ontario Secondary School Diploma (OSSD)](/ossd-requirements/) Requirements for all course.



## CGC1WF Frequently Asked Questions

### What is CGC1WF?

CGC1WF is a Grade 9 French Immersion Issues in Canadian Geography course De-streamed.

### What are WF courses?

1F refers to the Grade level of the courses and the pathway. 1 means it is a grade 9 course and F means it is a French Immersion course.

**[Click here for more information on Course Coding System](/course-coding-system/)**

### What is the Prerequisite Course for CGC1WF?
...
### How Long Does it take to Complete the CGC1WF Online Course?
...
2. **Embed Video**: Enjeux géographiques du Canada, 9e année, décloisonné. CGC1WF Sample lesson
   - URL: `about:blank;`
3. **Vimeo Video**: CGC1WF Enjeux géographiques du Canada, 9e année, décloisonné.
   - URL: `https://player.vimeo.com/video/356239528?title=0&byline=0&portrait=0&color=ffffff&autoplay=1&dnt=0&muted=0`
